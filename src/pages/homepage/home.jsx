...
<section class="w-full px-8 text-gray-700 bg-white">
    <div class="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
        <div class="relative flex flex-col md:flex-row">
            ...
            <nav class="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200 bg-pink-500 text-white">
                <a href="/" class="mr-5 font-medium leading-6 text-white bg-pink-500 hover:text-gray-900">Home</a>
                <a href="/product-list" class="mr-5 font-medium leading-6 text-white bg-pink-500 hover:text-gray-900">Products</a>
                <a href="/cart" class="mr-5 font-medium leading-6 text-white bg-pink-500 hover:text-gray-900"><FaCartShopping/></a>
                <a href="/pricing" class="mr-5 font-medium leading-6 text-white bg-pink-500 hover:text-gray-900">Pricing</a>
                <a href="/about" class="mr-5 font-medium leading-6 text-white bg-pink-500 hover:text-gray-900">About Us</a>
            </nav>
        </div>
    </div>
</section>
    ...
    <div class="flex flex-wrap items-center sm:-mx-3">
      <div class="w-full md:w-1/2 md:px-3">
        <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
            <span class="block xl:inline">Welcome to AI – </span>
            <span class="block text-indigo-600 xl:inline">Where Style Meets Convenience.</span>
          </h1>
          <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Discover a shopping experience like no other at AI</p>
          <div class="relative flex flex-col sm:flex-row sm:space-x-4">
            <a href="/product-list" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
              Check The Products
      ...
      <div class="w-full md:w-1/2">
        <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
            <img src= "https://plus.unsplash.com/premium_photo-1720503965220-10ea698bf0aa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDJ8fHxlbnwwfHx8fHw%3D" />
          </div>
      </div>
    </div>
  </div>
